...
function Server(compiler, options) {
  ...
  if(options.contentBase !== false) {
    ...
    var contentStatic = options.contentStatic;
    console.log('Content Static', options.contentStatic);
    ...
    if(typeof contentBase === "object") {
      ...
      app.get("*", this.serveMagicHtml.bind(this), express.static(contentBase), serveHTML(contentBase, contentStatic), serveIndex(contentBase));
    }
  }
}

function serveHTML(path, file){
